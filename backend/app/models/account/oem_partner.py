...
class OEMPartner(BaseModel):
    ...
    account = db.relationship("Account", back_populates="oem_partners")
    opportunity_associations = db.relationship("OEMOpportunity", back_populates="oem", cascade="all, delete-orphan", lazy=True)
